...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        jump = Gdx.audio.newSound(Gdx.files.internal("bounce.wav"));
        clap = Gdx.audio.newSound(Gdx.files.internal("clap.wav"));
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.bryan.thogerson.jumpactiongame");
